...
class InvoiceExportVatShiftedCalculationsDelegate extends InvoiceCalculationsForVatShiftedDelegate {
    InvoiceExportVatShiftedCalculationsDelegate(Invoice invoice, VatRepository vatRepository) {
